...
MCC = $(MATLAB)/bin/mcc
MATFLAGS = -I ../cmig_utils/B0_distortion -I ../cmig_utils/ctxmgh -I ../cmig_utils/dicom \
	-I ../cmig_utils/dicom/rt_dicom -I ../cmig_utils/dicom/dicts -I ../cmig_utils/dicom/seg_dicom \
	-I ../cmig_utils/dmri -I ../cmig_utils/dmri/model_fitting -I ../cmig_utils/eddy_current \
	-I ../cmig_utils/gradient_nonlinearity -I ../cmig_utils/matlab \
	-I ../cmig_utils/mmps -I ../cmig_utils/morphometry -I ../cmig_utils/morphometry/volgetvxlsvalMEX \
	-I ../cmig_utils/morphometry/volgetCOMMEX -I ../cmig_utils/morphometry/resliceMEX \
	-I ../cmig_utils/motion  -I ../cmig_utils/ctxmgh/coords/ \
	-I ../cmig_utils/B0_distortion/mrpg -I utils -I preprocessing -I autoseg \
	-a protocols/artpro_protocol_reference.mat -a ../cmig_utils/dicom/dicts/gems-dicom-dict.txt
...
test_processRSI/test_processRSI: test_processRSI.m
	$(MCC) -m $< -d $(basename $<) $(MATFLAGS)
...
clean:
	rm -rf RSI_pipeline_multisort test_processRSI contour_prostate
...
run_test: test_processRSI/test_processRSI
	cd data/ && MMPS_DIR=$(MMPS_DIR) ../test_processRSI/run_test_processRSI.sh $(MATLAB) ../example_params.m
